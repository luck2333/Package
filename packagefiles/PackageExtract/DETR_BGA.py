...
DETR_OUTPUT = 'Result/Package_extract/detr_output'
...
if __name__ == "__main__":
    ...
    classes = ['BGA_Border', 'BGA_PIN', 'BGA_serial_letter', 'BGA_serial_number', 'multi_value_1', 'multi_value_2',
               'multi_value_3', 'multi_value_triangle', 'other', 'pairs_inside_col', 'pairs_inside_row', 'pairs_outside_col',
               'pairs_outside_row']

    # img_path = r"BGA_img/3.png"
    dir_path = "BGA_img"
    output_file = "onnx_output"
    images = os.listdir(dir_path)
    for img in images:
        img_path = os.path.join(dir_path,img)
        print(img_path)

        boxes, scores, labels = DETR_per_img(output_file, img_path, classes)

    # boxes, scores, labels = DETR_per_img(img_path, classes)
