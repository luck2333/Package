...
def watermark_remove(path):
    ...
    if (flag == 0):
        ...
        #time4 = time.time()
        #print(f"去除annot时间为{time2 - time1}")
        #print(f"去除img时间为{time3 - time2}")
        #print(f"去除x时间为{time4 - time3}")

if __name__ == "__main__":
    # 函数测试
    #time1 = time.time()
    path = r"C:/Users/17550/Desktop/7418b76c3e1ae51041915e30a501cc2f_b6a1b200014c1d901b0aa66c0ea7a944_8.pdf"
    watermark_remove(path)
    #time2 = time.time()
    #print(time2 - time1)
